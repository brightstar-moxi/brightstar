    ...
    return (
        <div className='flex flex-col text-center justify-center'>
            ...
            <p className='text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto'>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit et necessitatibus consectetur ratione illum saepe minima quaerat id optio, ab tenetur atque ipsam soluta rem explicabo qui! Asperiores, sequi debitis.
            </p>
        </div>
    )
}
